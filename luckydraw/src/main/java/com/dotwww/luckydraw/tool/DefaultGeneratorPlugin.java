package com.dotwww.luckydraw.tool;
...
public class DefaultGeneratorPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaces, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        for (String mapper : rootMappers) {
            interfaces.addImportedType(new FullyQualifiedJavaType(mapper));
            interfaces.addSuperInterface(new FullyQualifiedJavaType(mapper + "<" + entityType.getShortName() + ">"));
        }
        //import实体类
        interfaces.addImportedType(entityType);
        interfaces.addImportedType(new FullyQualifiedJavaType("org.apache.ibatis.annotations.Mapper"));
        interfaces.addAnnotation("@Mapper");
        return true;
    }
